...
from objects.utils import rebuildSession, flashrect, render_template_flashrect as render_template # render_template is redefined because of flashrect() function
...
async def check_session():
    required_keys = ["authenticated", "user_data", "flash_data"] # if any one is missing, initialize session
