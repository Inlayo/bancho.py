...
async def api_get_player_info(
    ...
    user_id: int | None = Query(None, alias="id", ge=1, le=2_147_483_647),
...
async def api_get_player_scores(
    ...
    if scope == "best":
        ...
        lb_sort = (
            "score" if mode_arg <= 3 else "pp"
        )  # vanilla goes by score, relax and ap by pp
        query = [
            "SELECT t.id, t.map_md5, t.score, t.pp, t.acc, t.max_combo, "
            "t.mods, t.n300, t.n100, t.n50, t.nmiss, t.ngeki, t.nkatu, t.grade, "
...
async def api_get_map_info(
    map_id: int | None = Query(None, alias="id", le=2_147_483_647),
