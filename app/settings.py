...
DISCORD_BEATMAP_LOG_WEBHOOK = os.environ["DISCORD_BEATMAP_LOG_WEBHOOK"]
DISCORD_LEADERBOARD_LOG_WEBHOOK = os.environ["DISCORD_LEADERBOARD_LOG_WEBHOOK"]
DISCORD_RANKREQ_LOG_WEBHOOK = os.environ["DISCORD_RANKREQ_LOG_WEBHOOK"]
